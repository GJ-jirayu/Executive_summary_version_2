...
<head>
    ...
    .ui-dialog-titlebar .ui-button-text{
        ...
        .progress .bar { padding-top: 3%; }
        .txtHead{ font-size: 2.5em;line-height: 1.5em; }
...
<div class="row-fluid body" style="border-bottom: 1px solid #e5e5e5;">
    <div class="languageChange">
        <div class="span6" style="display: inline-flex;">
            ...
            <span id="${ns}year_section" style="padding-left: 5px"></span>
            <span style="padding-left: 5px" style="width: 90%">
                <button id="viewDashboard" onclick="${ns}renderDashboard()" style="padding:2.5px;">
                    <span id="${ns}view_languageMap" style="font-size:16px;">${kissLanguage.languageMap['view']}</span>
                </button>
            </span>
        </div>
        <div class="span6">
                ...
                <div class="span6">
                            ...
                            <div class="stdBox">
                                <div class="row-fluid">
                                    <div class="row-fluid">
                                        ...
                                        <div style="width: 5%; float: left; margin-top:2%;">
                                            <div class="Box orangeText textC fontLevel01"> <b> + </b> </div>
                                        </div>
                                        <div style="width: 30%; float: left;">
                                            <div class="orangeText textC fontLevel01" id="institute" style="margin-top:9%;"> 0 </div>
                    ...
                    <div class="row">
                        <div class="span12 pad">
                            ...
                            <div class="row-fluid">
                                <div style="width:77%; float:left; margin-right: 3%; text-align: right;">
                                    <div id="${ns}programs_for_graduate_languageMap" class="smlBlue fontLevel04" style="width:80%; vertical-align:middle; float:left; margin-top:1.5em; text-align:left; padding-right:0; padding-left:35%;">
                            ...
                            <div class="span12" style="margin-top:10px;">
                                <div style="background:#ccc;padding:1%;color:#000;">
                                    <div id="${ns}international_program_languageMap" class="fontLevel04" style="font-weight: bold;">${kissLanguage.languageMap['international_program']}</div>
                                    <div class="row-fluid" style="margin-top:5px;font-weight: bold;">
                                        <div class="fontLevel01" style="width:25%; float:left; margin-top:5px; margin-right:5%; text-align:right;" id="international_program"> 0 </div>
                                        <div class="fontLevel01" style="width:8%; float:left; margin-top:5px; text-align:left;"> } </div>
        ...
        <div class="span4">
            <div class="row">
                <div class="span12 pad">
                    ...
                    <!-- INCOMES pie -->
                    <div class="typeChart whiteText span8 offset2 textC" style="margin-top:3%;">
                        <span id="${ns}incomes_1_languageMap">${kissLanguage.languageMap['incomes_1']}</span>
                        <span id="income_amount_format">0</span>
                        <span name="${ns}million_baht_languageMap">${kissLanguage.languageMap['million_baht']}</span>
                    </div>
                    <div style="padding:0 10%;">
                        <div id="${ns}chartContainer1"></div>
                    </div>
                    <!-- <div  class="smlBlue midle textC fontLevel04">
                        <span id="${ns}incomes_2_languageMap">${kissLanguage.languageMap['incomes_2']}</span>
                        <span id="income_amount_format"></span> <span name="${ns}million_baht_languageMap">${kissLanguage.languageMap['million_baht']}</span>
                    </div> -->
                    <br/>
                    <!-- EXPENSES pie -->
                    <div class="typeChart whiteText span8 offset2 textC">
                        <span id="${ns}expenses_1_languageMap">${kissLanguage.languageMap['expenses_1']}</span>
                        <span id="expense_amount_format">0</span>
                        <span name="${ns}million_baht_languageMap">${kissLanguage.languageMap['million_baht']}</span>
                    </div>
                    <div style="padding:0 10%;">
                    ...
                    <!-- <div class="smlBlue midle textC fontLevel04">
                        <span id="${ns}expenses_2_languageMap">${kissLanguage.languageMap['expenses_2']}</span>
                        <span id="expense_amount_format"></span>
                        <span name="${ns}million_baht_languageMap">${kissLanguage.languageMap['million_baht']}</span>
                    </div> -->
                </div>
...
<script type="text/javascript" src="<c:url value="/../html/js/editor/ckeditor/ckeditor.js" />"></script>
<script type="text/javascript" src="<c:url value="/resources/jquery-ui/js/jquery-ui-1.10.4.custom.min.js"/>"></script>
